...
public final class JSONUtils {
   ...
   * <li>get {@link #getJSONObject(JSONObject, String, JSONObject)} by recursion, return it. if
   * anyone is
  ...
  /**
   * parse key-value pairs to body. ignore empty key, if getValue exception, put empty value
   *
   ...
   * </ul>
   */
  @SuppressWarnings("rawtypes") public static TreeMap<String, String> parseKeyAndValueToMap(
   ...
   * @return <ul>
   * <li>if source is null or source's length is 0, return empty body</li>
  ...
  public static Map<String, String> toObjectMap(String source) {
    if (StringUtils.isEmpty(source)) {
      return null;
    }
    HashMap<String, String> map = new HashMap<>();
  ...
  public static <T> T parseJsonToBean(String json, Class<T> cls) {
    ...
    T t = null;
    try {
      t = gson.fromJson(json, new TypeToken<Class<T>>() {
      }.getType());
    } catch (Exception e) {
    }
    return t;
